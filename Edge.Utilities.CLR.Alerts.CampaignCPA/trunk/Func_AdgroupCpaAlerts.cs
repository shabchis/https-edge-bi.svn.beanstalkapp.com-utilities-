...
public partial class UserDefinedFunctions
{
    ...
    public static SqlString Func_AdgroupCpaAlerts(Int32 AccountID, Int32 Period, DateTime ToDay, string ChannelID, Int32 threshold, string excludeIds, string cubeName, string acqFieldName, string cpaFieldName, string acq2FieldName, string cprFieldName)
    {
        ...
        catch (Exception e)
        {
            ...
            return  string.Format("<br><br>Execution Time: {5:dd/MM/yy H:mm} GMT <br><br>Time Period: {0} - {1} ({2} Days) <br><strong> AVG CPA: ${3} </strong><br> Defined Threshold: {4}00% <br>",
