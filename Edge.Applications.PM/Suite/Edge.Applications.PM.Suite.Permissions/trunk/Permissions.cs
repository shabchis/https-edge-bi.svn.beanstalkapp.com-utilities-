...
{
	public partial class Permissions : ProductionManagmentBaseForm
	{
		...
		private void BuildUserPermissionsTree(List<Permission> permissions)
		{
			...
			userPermissionTree.ImageList.Images.Add("question_blue.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\question_blue.ico")));
			userPermissionTree.ImageList.Images.Add("question_blue-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory,@"Resources\question_blue-faded.ico")));
			userPermissionTree.ImageList.Images.Add("tick_circle.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory,@"Resources\tick_circle.ico")));
			userPermissionTree.ImageList.Images.Add("tick_circle-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory,@"Resources\tick_circle-faded.ico")));
			userPermissionTree.ImageList.Images.Add("cancel_round.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory,@"Resources\cancel_round.ico")));
			userPermissionTree.ImageList.Images.Add("cancel_round-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory,@"Resources\cancel_round-faded.ico")));
		...
		private void BuildGroupPermissionsTree(List<Permission> permissions)
		{
			...
			groupsPermissionTree.ImageList.Images.Add("question_blue.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\question_blue.ico")));
			groupsPermissionTree.ImageList.Images.Add("question_blue-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\question_blue-faded.ico")));
			groupsPermissionTree.ImageList.Images.Add("tick_circle.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\tick_circle.ico")));
			groupsPermissionTree.ImageList.Images.Add("tick_circle-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\tick_circle-faded.ico")));
			groupsPermissionTree.ImageList.Images.Add("cancel_round.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\cancel_round.ico")));
			groupsPermissionTree.ImageList.Images.Add("cancel_round-faded.ico", Image.FromFile(Path.Combine(Environment.CurrentDirectory, @"Resources\cancel_round-faded.ico")));
